...
export function launchRuntime(binaryPath, provider) {
...
export async function readRuntimeStartupState(provider) {
    try {
        const value = JSON.parse(await readFile(startupPath(provider), "utf8"));
