...
export declare const SDK_VERSION: "0.3.0-alpha.1";
export declare const BUILD_ID: "ab-runtime@0.3.0-alpha.1+fb5503e4c98f0b9f";
...
export type LocatorQuery = {
    ...
    "kind": "descendant";
    ancestor: LocatorQuery;
    descendant: LocatorQuery;
} | {
    "kind": "has";
    query: LocatorQuery;
    descendant: LocatorQuery;
...
export type ElementInspectionRequest = {
...
//# sourceMappingURL=protocol-v3.d.ts.map